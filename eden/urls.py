...
router.register(r'clips', views.ClipViewSet, basename='clip-api')
...
api_urlpatterns = [
    ...
    # HTMX partials (can be considered part of the API surface)
...
urlpatterns = [
    ...
    path('branch/<str:character>/', views.branch_view, name='branch'),
